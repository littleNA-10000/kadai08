...
$stmt = $pdo->prepare("INSERT INTO oxcgrt_list(id,countryname,startdate,enddate,comment,timeseries_flag)VALUES(NULL,:a1,:a2,:a3,:a4,:a5)");
...
else {$stmt = $pdo->prepare("INSERT INTO oxcgrt_list(id,comment,date,countries_flag)VALUES(NULL,:a4,:a6,:a7)");
$stmt->bindValue(':a4', $comment, PDO::PARAM_INT);  //Integer（数値の場合 PDO::PARAM_INT)
